...
'''
Step 2: Define the neural network class (same step)
'''
class LR(nn.Module) :
    '''
    Initialize model
...
'''
Step 3: Create the model, specify loss function and optimizer. (same step)
'''
